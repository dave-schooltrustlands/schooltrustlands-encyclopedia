---
title: The Cyclopedia of Education — A Dictionary of Information for the Use of Teachers, School Officers, Parents, and Others
author: Henry Kiddle and Alexander J. Schem, editors
era_cohort: High-water mark (1860–1910)
year: 1877
length: ~870 pages
register: Reference; period professional voice
...
- Alphabetical entries from "Abacus" through "Zürich, Schools of."
- State-system entries — one per U.S. state and territory, summarizing law, finance, enrollment, and administration as of 1877.
- "Common Schools" — the master entry on the American common-school institution.
- "School Funds, State" — entries on the permanent funds, their origins, and their administration.
- "Trust Funds" — the period treatment of the fiduciary category.
- Biographical entries on Horace Mann, Henry Barnard, Calvin Wiley, John D. Pierce, and the other state-system founders.
- Comparative international entries — Prussia, France, England, Switzerland — establishing the period's reference frame.
- Entries on school architecture, on the normal-school movement, on the kindergarten (recently arrived from Germany).
- Statistical appendices by state — enrollment, expenditure, teacher counts, fund balances.
- Entries on contested institutional questions — religious instruction, segregation, compulsory attendance, the rate-bill.
...
- Full text: Internet Archive — search "Kiddle Schem Cyclopedia of Education" at https://archive.org/search?query=kiddle+schem+cyclopedia+of+education — multiple scanned editions are available (E. Steiger 1877 and Steiger's reissues); canonical IA identifier confirmation pending.
