---
title: "If you have not signed up yet"
slug: "visitors"
order: 1
summary: "What you can do without a Library Card."
---
...
- Read every open discussion thread.
- Search across the whole site using the search box at the top of every page.
- Save URLs in your own browser bookmarks the same way you would save any other web page.
...
- Submit feedback on a page.
- Submit a correction to a page.
- Write a review of one of the books.
- Reply to a discussion thread, or start a new one.
- Upload files (a photograph, a letter, a scanned record).
...
Visit [/library-card/](/library-card/). The Library Card is free, forever, with no payment of any kind. The sign-up form asks for your email address and not much else, and the whole process takes about a minute. You will get an email with a sign-in link. Click it, and you have a Card.

If you get stuck on the sign-up form, there is a *Submit feedback* link at the bottom of every page — including [/library-card/](/library-card/) itself. Send a note and a librarian will help.
