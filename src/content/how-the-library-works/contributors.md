...
slug: "contributors"
order: 3
summary: "Feedback, corrections, reviews, discussions, citizen-historian uploads."
---
...
You need a Library Card to use any of these channels. The Card is free; see [Reading and the Library Card](/how-the-library-works/readers/) if you do not have one yet.
...
**What happens next.** You get a ticket number like FB-2026-00042, viewable on your [My Library](/my-library/) page under *My tickets*. A librarian reads it. They may respond directly — you will see the response on your ticket and in your Inbox — or they may close the ticket as noted. Not every piece of feedback needs a reply.
...
1. *The claim that's wrong* — paste the exact sentence or number from the page, so the librarian can find it.
2. *Your proposed fix* — what the page should say instead.
3. *A source backing your fix* — a citation, a URL, a book and page number, a document.
4. *The reasoning* — why your source supports your fix.
...
**How to submit.** Visit [/discussions/](/discussions/). To start a new thread, click *Start a thread*, give it a title, and write the opening post. To reply, open a thread and use the reply box at the bottom.

**What happens next.** Each thread gets a ticket number like DI-2026-00031, viewable on your [My Library](/my-library/) page. Threads are public — anyone can read them. Only Card holders can post or reply. Discussion moderators have tools to hide posts or lock threads when needed; see [Discussion moderators](/how-the-library-works/moderators/).
...
**How to submit.** Use the correction channel. Go to a page that the material relates to — a state page, a chapter, or just [/about/](/about/) if it does not match a specific page. Click *Submit a correction to this page*. In the body, write a brief description of what you are submitting and where it came from. In the upload control, attach the file or files.

**What happens next.** The head librarian reads the submission, evaluates the material, and either accepts it into the source library (and grants you the *citizen historian* badge on your Card), declines with a reason, or asks for more information about the source. See [Citizen historians](/how-the-library-works/citizen-historians/) for more on what the head librarian is looking for.
...
The librarian queue can be longer than usual at times — especially when a book release or a court ruling drives a wave of feedback. You can check the status of any ticket on your [My Library](/my-library/) page, under *My tickets*. If a ticket has been open for more than a month with no movement, send feedback and a librarian will look into it.
