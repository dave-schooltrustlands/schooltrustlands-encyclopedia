...
The Nebraska Supreme Court in *State ex rel. Ebke v. Board of Educational Lands and Funds*, 154 Neb. 244, 47 N.W.2d 520 (1951), held that the constitutional designation of school lands as trust property incorporates the common law of trusts and that breach of those duties is itself a constitutional violation. The state, the court wrote, "in acting as a trustee is subject to the same standards, and when its status as a trustee is fixed by the Constitution a violation of its duty as a trustee is a violation of the Constitution itself." *Ebke*, 154 Neb. at 249. The court made the highest bid the trustee's default, with the burden on the trustee to justify any departure; it left the procedure to the Legislature within fiduciary limits, naming public auction "or . . . some other method to be provided by statute consonant with the rules of law applicable to trustees acting in a fiduciary capacity." *Id.* at 250.
...
The Idaho Supreme Court in *Idaho Watersheds Project v. State Board of Land Commissioners (IWP II)*, 133 Idaho 64, 982 P.2d 367 (1999), applied the strict-trust theory to grazing leases in a different way: it struck the statute. Idaho Code § 58-310B had directed the Land Board, in resolving competing lease applications, toward "the schools, the state, and the Idaho livestock industry." The court held the direction itself unconstitutional, because Article IX, § 8 "requires that the State consider only the 'maximum long term financial return' to the schools." 133 Idaho at 67. *(Corrected August 23, 2026. This paragraph previously described a fiduciary-breach holding the opinion does not contain — the words* fiduciary, breach *and* market *appear nowhere in it — and attributed to it a beneficiary-standing holding that no Idaho case supports. The plaintiff in* IWP II *had standing as a rejected bidder, not as a beneficiary, and no Attorney-General-exclusivity argument was made or rejected. See [correction 019](/about/corrections/log/).)*
...
The Oklahoma Supreme Court in *Oklahoma Education Association v. Nigh*, 642 P.2d 230 (Okla. 1982), held unconstitutional five statutes that capped the rent and interest the school land trust could charge and let a sitting lessee renew without matching competing bids, because they required the trustee to manage for less than full value in order to subsidize farmers and ranchers. The state's acceptance of the grant, the court held, made the constitution and the Enabling Act "an irrevocable compact between the United States and Oklahoma, for the benefit of the common schools, which cannot be altered or abrogated." *Id.* at 235. The South Dakota Supreme Court in *Kanaly v. State*, 368 N.W.2d 819 (S.D. 1985), catalogued the synonymous formulations courts have used to describe the school land grant — "irrevocable compact" (*Nigh*), "solemn agreement" (*Andrus*), and "contract" (*Platte Valley*) — and confirmed that "these provisions create a special, permanent and perpetual trust of all land, money, property, and proceeds of the same, donated to the state for educational institutions by the United States and individuals alike." *Id.* at 823.
...
The first is the duty of undivided loyalty. *Skamania* is the leading modern articulation in the state-court line: the trustee must act in the exclusive interest of the beneficiaries, and any law or administrative practice that uses trust assets to advance other public purposes — however sympathetic — is a breach. *Ebke* anticipated the same rule in 1951: "It is a fundamental principle that a trustee owes beneficiaries of a trust his undivided loyalty and good faith, and all his acts as such trustee must be in the interest of the cestui que trust and no one else." 154 Neb. at 249. *Lassen* embedded the principle at the federal level by insisting that the granting Congress had intended "that only those beneficiaries profit from the trust." 385 U.S. at 468.

The second is the duty of income maximization, sometimes phrased as the duty to obtain full value on any disposition. *Ebke* required the trustee to take the highest bid absent cogent reasons. *Pettibone* required full compensation for any alienation of any interest in the trust corpus, including appurtenances such as water rights. *IWP II* reached the same end by a different route, holding that a legislature may not direct the trustee to weigh anyone but the beneficiary when it decides how trust land will be leased. *NPCA v. Board of State Lands* held that a purchaser-supplied appraisal is suspect on its face and cannot serve as the trustee's basis for fair market value. The duty has many specific applications, but the underlying principle is uniform: the trustee must obtain the highest available return on the trust assets, consistent with prudence and the long-term productivity of the corpus.
...
- *State ex rel. Ebke v. Board of Educational Lands and Funds*, 154 Neb. 244, 47 N.W.2d 520, modified, 154 Neb. 596, 47 N.W.2d 526 (1951).
...
- Cross-reference to *IWP II*'s exact statutory anchor: the opinion cites the "Idaho Admission Bill, 26 Stat. L. 215, ch. 656, § 5(a)" for the rule that proceeds "shall be reserved for school purposes only," 133 Idaho at 67.
