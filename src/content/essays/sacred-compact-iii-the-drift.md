...
The clearest case is California. The 1850 California Admission Act, passed in the political fever of the Compromise of 1850, contains none of the structural commitments the other public-land states received at admission. No school-section grant. No "propositions" package — the offer-and-acceptance language by which Congress and the new state entered into a bilateral, irrevocable compact. No "in trust" language. The act admits California to the Union and stops.[^III-2] Read it alongside the contemporaneous Wisconsin or Minnesota admission acts, and the absence is not stylistic. It is structural.

The federal grant for California schools arrived three years later, in section 6 of the Public Lands Survey Act of March 3, 1853, and it arrived in eight words: sections 16 and 36 of every township, granted to California "for the purposes of public schools."[^III-3] No "in trust" language. No fiduciary clause. No restoration mechanism. No federal Attorney General enforcement provision. The 1853 act is ordinary federal legislation, not a compact. The Supreme Court interpreted the grant in *Sherman v. Buick* in 1876, and the doctrinal architecture available to a California school-trust litigant in 2026 is essentially what *Sherman* leaves on the books.[^III-4] It is thinner than what is available in any other public-land state.

California's 1849 state constitution did its own work — Article IX, Section 2 declared the proceeds of the grant "inviolably appropriated to the support of common schools throughout the State" — but the language is appropriations doctrine, not fiduciary doctrine.[^III-5] It binds the legislature against one specific kind of breach. It does not articulate the fiduciary duties — undivided loyalty, prudent investment, the rule against self-dealing, the duty to defend — that a trust framework supplies elsewhere.
...
Drift by omission does not require malfeasance. It requires only that the architecture not be there to begin with. Where the architecture is absent, the trust does not strictly *drift* — it never quite functions as a trust at all.
...
The Oregon record begins, as the framers would have wished, with strong language. The 1859 Admissions Act ceded to the new state sections 16 and 36 of every township for the support of public schools, and Oregon's own constitution doubled down.[^III-10] Article VIII, Section 2 of the 1857 constitution declared the proceeds of the school lands a "separate and irreducible fund," dedicated "exclusively" to common schools and the libraries that supported them. Section 5 placed the lands in the hands of a board composed of the Governor, the Secretary of State, and the State Treasurer.[^III-11] The architecture, on paper, was as strong as anything else in the public-land system.

What followed it was not.

F. G. Young's 1910 *Oregon Historical Quarterly* paper — written by Oregon's first professor of economics about his own state's first half-century — describes the operating disposition without softening it:[^III-12]

> it has been Oregon's unwavering aim to get its state lands as rapidly as possible into private hands and under cultivation … every acre as soon as the state had title, and quite too frequently even when it had only slight basis for expecting to secure it, was on the market.
...
The doctrinal floor was, in fact, articulated cleanly when the courts had occasion to look at it. The Oregon Supreme Court called the Common School Fund a "trust of the highest nature" in *Eagle Point Irrigation District v. Cowden* (1931).[^III-15] Oregon's own Attorney General, in 1992 and again in 2003, concluded that "the school lands granted to the State of Oregon are a trust for the benefit of public education" and that the State's "obligations are binding. They cannot be disregarded. Oregon must use [Admission Act lands] consistent with the trust."[^III-16] A 1983 AG opinion stated, in the plainest English, that "the Common School Fund is a trust which must be invested by the State Land Board or the State Treasurer only in such manner as will obtain the maximum financial benefit over time to the fund."[^III-17] The architecture, as the State's own legal officers periodically restated it, was correct. What did not happen was the operational defense the architecture assumed.

Drift by attrition is what happens when the architecture exists on paper and the constituency who would enforce it does not. Oregon held that posture for sixty years, until the federal land-fraud trials forced a reckoning that produced no structural reform. The pattern then went underground for most of the twentieth century, in a relative-stewardship period from roughly 1920 to 1990 when professional state-foresters and a sustained-yield culture inside the timber industry held the trust in something close to its design.

What broke the relative-stewardship period is the next category.
...
The Elliott had been, for most of the twentieth century, the workhorse asset of Oregon's Common School Fund — 93,000 acres of Coast Range Douglas-fir managed for sustained-yield timber production, generating reliable annual revenue for the schools.[^III-18] By the mid-2010s, the State Land Board had concluded that the Elliott was a net drain on the Common School Fund. Litigation over endangered-species protections had reduced the harvestable acreage. The political costs of timber harvest in the Coast Range had outrun the school revenue. The Board's judgment, defensible inside the agency's frame, was that the trust would be better served by selling the asset and reinvesting the proceeds.

In 2017, the State Land Board voted to sell the forest in a single transaction to a private buyer, then reversed under public pressure. In 2019, the state issued $100 million in bonds to compensate the Common School Fund for the Elliott's reduced timber revenue. By 2022, the legislature had approved a plan to convert the Elliott into a research forest managed by Oregon State University, with bonds and other appropriations standing in for the timber receipts the trust would otherwise have received.[^III-19]

Each step had a defensible rationale. The aggregate is the structural pattern. An asset reserved in 1859 for common schools became, between 1990 and 2022, an asset whose use was decided by a coalition of state agencies, university administrators, environmental advocates, and legislators — none of whom were the trust's beneficiaries, and most of whom had institutional interests other than maximizing common-school funding. The bond compensation is real money, but the bonds are general-obligation debt of the state, paid back from general revenue. The trust's claim on a particular working asset has been converted to the trust's claim on a particular line item in the state budget. That is not the same thing. A line item is what the legislature appropriates each biennium. The 1859 reservation was supposed to be more durable than that.
...
The 2024 and 2023 OASTL cases — *Advocates for School Trust Lands v. State of Oregon*, including the January 28, 2026 Court of Appeals opinion that gave plaintiffs standing on Article VIII, Section 8 claims — are the moment when, after 167 years, an organized beneficiary constituency finally appeared inside the courthouse and asserted the trust against the state as trustee.[^III-24] The appellate court summarized the OASTL claims as alleging that the State was required "to manage the common school lands … in a way that would maximize school funding," and that the Elliott "was sold for less than its fair market value."[^III-24]
...
The story belongs to Scott M. Matheson, a Stanford-trained lawyer who became Utah's first Democratic governor in twenty years when he took office in January 1977. Matheson understood trust law in the technical sense most governors do not. He had practiced it before he entered politics. He inherited a school-trust portfolio of approximately three million acres, scattered across the state in the section-16-and-36 reservation pattern that the 1894 Utah Enabling Act had produced.[^III-25] The scattered geometry was, as a matter of asset management, a problem. A state cannot manage three million acres efficiently when those acres are distributed in two-mile-square parcels across the entire state.

Project Bold, the policy initiative Matheson developed and pushed publicly between roughly 1982 and 1984, proposed a solution that on its face was sound: aggregate the scattered parcels through land exchanges with the federal government, blocking up the trust holdings into manageable contiguous areas where economies of scale could be realized.[^III-26] The State School Board was approached for support on the rationale that consolidation would substantially increase the trust's revenue per acre. The board's support was solicited.

That much is well-documented. Project Bold's macro story is treated in the academic literature as a transitional Utah policy artifact — an early 1980s push toward the consolidated trust-management architecture that Utah eventually achieved, in different form, through the Leavitt-Babbitt Utah Schools and Lands Exchange Act of 1998 and the subsequent exchange acts of 2009 and 2025.[^III-27]

Margaret Bird's account adds a detail the academic literature does not address. According to her contemporaneous recollection — she was on staff at the Utah State Office of Education during the relevant period, and later led the school trust lands program there — Project Bold contained, on page 124 of the proposal, language quietly requesting Congress to amend the Utah Enabling Act so that the federal grant of school trust lands would flow "to the state" rather than "for public schools."[^III-28]
...
Utah's 1983 case is the historical predicate. In *Jensen v. Dinehart* (1982), the Utah Supreme Court ruled that mineral proceeds from school lands could be deposited in the Uniform School Fund — the state's general K-12 operating account — rather than the permanent State School Fund.[^III-34] In 1983, with Utah in a budget crisis, the legislature withdrew $37.5 million from the State School Fund to cover the year's educational appropriations. The fund balance fell from $53,500,836 in 1982 to $18,583,248 in 1983. In a single year, two-thirds of the permanent endowment was converted into operational cash.[^III-35]

The Utah constitution, Article X, contained the same protection Nebraska's does: "All public school funds shall be guaranteed by the State against loss or diversion."[^III-36] On paper, the 1983 withdrawal could not happen. In practice, it did. This is what the encyclopedia calls *directed seizure*: a legislature reaching past a constitutional guaranty to take principal it had been told it could not touch. The architecture, on paper, said the withdrawal could not happen. The architecture, in practice, did not stop it.

What stopped it from staying that way was the recovery — and the recovery is the subject of Section V. The Utah PTA, the Utah Education Association, the Utah State Board of Education, the Utah School Boards Association, and the two principals' associations educated themselves on the trust over the next two years. By 1991 they had pushed the legislature to create a task force; by 1992 the task force had produced a slate of bills; in 1994 the legislature enacted Title 53C, the *School and Institutional Trust Lands Management Act*. The pre-reform $50 million fund became, over the next thirty years, the $3.2 billion permanent fund Utah Trust Lands today reports.[^III-37]

That recovery is the most important data point in this paper. The architecture that allowed the 1983 collapse is the same architecture that supported the recovery. Article X did not change. The federal Enabling Act did not change. What changed was the constituency. This is the encyclopedia's central thesis, and the next section will adopt it.

Directed seizure by floor vote is not stopped by drift defenses. It is stopped by the people who would have to be willing to sue, to mobilize, to vote out, to raise the cost. In Nebraska in 2026, those people did not appear in time. In Utah after 1989, they did. The five years between collapse and reform organization are the operative span. That is the time horizon the next section will argue any aspirational trust must plan for.
...
The encyclopedia carries the fifty-state evidentiary record. What this paper carries is the typology and the architecture that responds to each category.

The pattern is national. The federal admission-act language hardened across the nineteenth century, from Ohio's single-section grant in 1802 to the maximalist 1910 New Mexico-Arizona language with explicit "in trust" and "deemed a breach of trust" clauses.[^III-39] But — and this is the encyclopedia's most consequential finding — the variation in *outcomes* does not map cleanly onto the variation in *language*. Same federal text, different states, different outcomes by a factor of four or more. Section IV takes that finding apart.

## Source notes

[^III-1]: *Schools of the Republic v1.3*, Part II (per-state encyclopedia entries) and Part I conclusion. The fifty-state comparative atlas underlies the typology developed here; the encyclopedia is the underlying evidentiary substrate. Substrate path: `L4_Deliverables/Book_Revision/Schools_of_the_Republic_v1.3_[INTERNAL].md`.

[^III-2]: Act of Sept. 9, 1850, ch. 50, 9 Stat. 452 (admitting California to the Union without an operative school-section grant). See *Schools of the Republic v1.3*, California encyclopedia entry, (see footnote ca-1) and (see footnote ca-2).

[^III-3]: Act of Mar. 3, 1853, ch. 145, § 6, 10 Stat. 244, 246–47 (granting sections 16 and 36 in each township to California "for the purposes of public schools"). See *Schools of the Republic v1.3*, California entry, (see footnote ca-5) through (see footnote ca-7).

[^III-4]: *Sherman v. Buick*, 93 U.S. 209 (1876); see also *Water & Mining Co. v. Bugbey*, 96 U.S. 165 (1878); *Mining Co. v. Consolidated Mining Co.*, 102 U.S. 167 (1880); *United States v. Sweet*, 245 U.S. 563 (1918) (the California school-grant doctrinal series). See *Schools of the Republic v1.3*, California entry, (see footnote ca-9) through (see footnote ca-29).

[^III-5]: California Constitution of 1849, Article IX, § 2 (proceeds of school-land grants "shall be and remain a perpetual fund, the interest of which … shall be inviolably appropriated to the support of common schools throughout the State"). See *Schools of the Republic v1.3*, California entry, (see footnote ca-13).

[^III-6]: California State Lands Commission, *Annual Report on the Management of State School Lands, Fiscal Year 2024–2025*, at i, 1 (approximately 458,843 fee-owned school-land acres against an original ~5.5 million-acre 1853 grant). See *Schools of the Republic v1.3*, California entry, (see footnote ca-8) and (see footnote ca-37).

[^III-7]: Cal. Pub. Res. Code § 6217.5 (directing net school-land use revenue to the State Teachers' Retirement Fund); CSLC, *Annual Report, FY 2024–2025*, at 21 (FY 2024–25 net revenue to CalSTRS Fund of $6,365,726.19). See *Schools of the Republic v1.3*, California entry, (see footnote ca-40).

[^III-8]: Del. Const. art. X, § 4 (Public School Fund clause); see *Schools of the Republic v1.3*, Delaware encyclopedia entry, (see footnote de-10).

[^III-9]: *Delawareans for Educational Opportunity v. Carney*, 199 A.3d 109 (Del. Ch. 2018); *In re Delaware Public Schools Litigation*, 239 A.3d 451 (Del. Ch. 2020). See *Schools of the Republic v1.3*, Delaware entry, (see footnote de-13); Chapter 1 (see footnote ch1-53).

[^III-10]: Act of Feb. 14, 1859, ch. 33, § 4, 11 Stat. 383, 384 (Oregon Admission Act, sections 16 and 36 grant). See *Schools of the Republic v1.3*, Oregon encyclopedia entry, (see footnote or-1) through (see footnote or-3).

[^III-11]: Or. Const. art. VIII, §§ 2, 5 (Common School Fund as "separate, and irreducible fund," exclusively dedicated to common schools and libraries; Governor, Secretary of State, and Treasurer as ex officio Land Board). See *Schools of the Republic v1.3*, Oregon entry, (see footnote or-9) and (see footnote or-11).

[^III-12]: F. G. Young, "Financial History of the State of Oregon: Oregon's Public Domain — The Sale of Oregon's Lands," *Oregon Historical Quarterly*, vol. 11 (1910), https://en.wikisource.org/wiki/Oregon_Historical_Quarterly/Volume_11/Financial_History_of_the_State_of_Oregon%3A_Oregon%27s_Public_Domain_-_The_Sale_of_Oregon%27s_Lands. See *Schools of the Republic v1.3*, Oregon entry, (see footnote or-6) and (see footnote or-12) through (see footnote or-19).

[^III-13]: O.L. 1887, p. 63 ("The Infamous Act"), discussed in F. G. Young, *supra* note III-12. See *Schools of the Republic v1.3*, Oregon entry, (see footnote or-16) and (see footnote or-17); Chapter 4 (see footnote ch4-44).

[^III-14]: "Oregon Land Fraud Trials (1904–1910)," The Oregon Encyclopedia, https://www.oregonencyclopedia.org/articles/oregon_land_fraud_trials_1904_1910_/; Stephen A. D. Puter, *Looters of the Public Domain* (1907), https://archive.org/details/publicd00putelootersofrich; Oregon History Project, "Land Fraud Trial of Senator John Mitchell," https://www.oregonhistoryproject.org/articles/historical-records/land-fraud-trial-of-senator-john-mitchell/. See *Schools of the Republic v1.3*, Oregon entry, (see footnote or-20) through (see footnote or-29).

[^III-15]: *Eagle Point Irrigation District v. Cowden*, 137 Or. 121, 1 P.2d 605 (1931). L0 source: `L0_Primary_Sources/Statutes/Oregon_AG_Opinions/Eagle Point 1931.pdf`.

[^III-16]: 46 Op. Att'y Gen. 468 (1992), Op. Att'y Gen. No. 8223 (July 24, 1992); Op. Att'y Gen. No. 8279 (2003). L0 sources: `L0_Primary_Sources/Statutes/Oregon_AG_Opinions/46 Op Atty Gen 468 (1992) - Op 8223 - July 24, 1992 - State Land Board.pdf`; `L0_Primary_Sources/Statutes/Oregon_AG_Opinions/AG Opinions 1992 and 2003 CSF.pdf`. See *Schools of the Republic v1.3*, Oregon entry, (see footnote or-44) through (see footnote or-46).

[^III-17]: 43 Op. Att'y Gen. 140 (1983). L0 source: `L0_Primary_Sources/Statutes/Oregon_AG_Opinions/43 Op AG 140 (1983).pdf`.

[^III-18]: Oregon Department of State Lands, "Elliott State Forest," https://www.oregon.gov/dsl/pages/elliott.aspx (1930 establishment; cumulative lifetime contributions exceeding $700 million to Oregon public schools). See *Schools of the Republic v1.3*, Oregon entry, (see footnote or-30) and (see footnote or-31).

[^III-19]: Oregon Public Broadcasting, "Oregon Sells $100 Million In Bonds For Elliott State Forest," https://www.opb.org/news/article/elliott-state-forest-bonds-oregon/ (Mar. 21, 2019); Oregon Department of State Lands, News Release, "Land Board Meeting Recap — December 2022," https://www.oregon.gov/dsl/Newsroom%20Documents/NewsRelease_LandBoardMeetingRecap_December2022.pdf (Dec. 13, 2022 Land Board vote authorizing decoupling on $221 million payment). See *Schools of the Republic v1.3*, Oregon entry, (see footnote or-51) through (see footnote or-53).

[^III-20]: 38 Op. Att'y Gen. 850 (May 17, 1977), Op. No. 7450, at 850–56 (income-producing Common School Grant Land cannot be designated as a Natural Area Preserve under ORS 273.562 where designation would adversely affect financial contribution to the Common School Trust Fund). L0 source: `L0_Primary_Sources/Statutes/Oregon_AG_Opinions/38 Op AG 850 (1977).pdf`.

[^III-21]: Zybach Expert Declaration, *Advocates for School Trust Lands v. State of Oregon*, Coos County 24CV38372, dated November 20, 2024, at ¶ 4. L0 source: `L0_Primary_Sources/Discovery/Expert_Declarations/Zybach Dec - 11-20-2024 -signed.pdf`.

[^III-22]: Stone Expert Declaration, *Advocates for School Trust Lands v. State of Oregon*, Coos County 24CV38372, dated November 20, 2024 (financial-loss projections for 2025–2027 biennium; comparison to private landowners under Oregon Forest Practices Act). L0 source: `L0_Primary_Sources/Discovery/Expert_Declarations/Greg Stone's Declaration 11-20-2024 - signed.pdf`.

[^III-23]: Hathaway Expert Declaration, *Advocates for School Trust Lands v. State of Oregon*, Coos County 24CV38372, dated November 20, 2024, at ¶¶ on State Land Board's "legally permissible" defense and the previous-AG-opinion contrast: "previous Attorney General opinions suggest otherwise, indicating that such management practices may violate fiduciary duties owed to public schools." L0 source: `L0_Primary_Sources/Discovery/Expert_Declarations/Hathaway's Dec 11-20-2024 -signed.pdf`, at lines 77–79 of extracted plaintext.

[^III-24]: *Advocates for School Trust Lands v. State of Oregon*, 346 Or. App. 668 (2026), decided January 28, 2026 (per Joyce, J.) (reversing trial court dismissal; standing for schoolchildren plaintiffs on Article VIII, § 8 claims; State of Oregon not immune from declaratory judgment regarding constitutionality of legislative acts). See *Schools of the Republic v1.3*, Oregon entry, (see footnote or-57) through (see footnote or-59); conclusion (see footnote conc-4). Live trial-court matter: Coos County 24CV38372.

[^III-25]: Utah Enabling Act, ch. 138, § 6, 28 Stat. 107, 109 (July 16, 1894) (quadrupled grant: sections 2, 16, 32, 36 of every township; total approximately 5.8 million school-grant acres at admission, 7.5 million combined surface acres including institutional grants). See *Schools of the Republic v1.3*, Utah encyclopedia entry, (see footnote ut-2) through (see footnote ut-6).

[^III-26]: Bryan Q. Cannon, *Land Grabbers, Toadstool Worshippers, and the Sagebrush Rebellion in Utah, 1979–1981*, BYU ScholarsArchive, https://scholarsarchive.byu.edu/cgi/viewcontent.cgi?article=1600&context=etd; *see also* contemporary High Country News coverage at https://www.hcn.org/wp-content/uploads/1983/03/1983_03_18.pdf. See *Schools of the Republic v1.3*, Utah entry, (see footnote ut-35) and (see footnote ut-37).

[^III-27]: Utah Schools and Lands Exchange Act of 1998, Pub. L. No. 105-335, 112 Stat. 3139 (Leavitt-Babbitt exchange; trust-preserving asset repositioning following Grand Staircase-Escalante National Monument designation). See *Schools of the Republic v1.3*, Utah entry, (see footnote ut-49) and (see footnote ut-50).

[^III-28]: Margaret Bird, oral account, recorded in *Utah Project BOLD research memo*, `L4_Deliverables/White_Paper/Sections/_Research/Utah_Project_Bold_research_v0.md`. See *Schools of the Republic v1.3*, Utah entry, (see footnote ut-36); see also Multimedia substrate, `L0_Primary_Sources/Multimedia/Margaret_Recordings/Margaret_Bird_Utah_Reform_Coalition_and_Arches_Exchange.md`.

[^III-29]: Scott M. Matheson Papers, J. Willard Marriott Library, University of Utah, Box 29; Archives West finding aid ark:80444/xv62567 (Project BOLD proposal materials; not digitized as of April 2026). See *Schools of the Republic v1.3*, Utah entry, (see footnote ut-38); conclusion (see footnote conc-8).

[^III-30]: Pub. L. No. 105-335, 112 Stat. 3139 (1998 Leavitt-Babbitt exchange); subsequent Utah trust-land exchange acts of 2009 and 2025. See *Schools of the Republic v1.3*, Utah entry, (see footnote ut-49) and (see footnote ut-50).

[^III-31]: Utah Code Title 53D, Chapter 2 (2018) (Land Trusts Protection and Advocacy Office; statutorily separate beneficiary-side advocacy agency under Section 53D-2-201). See *Schools of the Republic v1.3*, Utah entry, (see footnote ut-55) and (see footnote ut-56).

[^III-32]: LB 1072, signed by Governor Jim Pillen, April 7, 2026; *Nebraska Examiner* coverage, January–April 2026; Nebraska Board of Educational Lands and Funds, *2024-2025 Annual Report*, https://prodbelf.nebraska.gov/pdf/reports/belf2024-25annual.pdf (BELF $3.047 billion in trust assets; FY 2025 distributions of $129,176,784.79). See *Schools of the Republic v1.3*, Nebraska encyclopedia entry, (see footnote ne-7) and (see footnote ne-27) through (see footnote ne-29).

[^III-33]: Neb. Const. art. VII, §§ 7–9 (Permanent School Fund "trust funds, solemnly pledged" to common schools, irreducible in principal, exclusively applied; Article VII, § 1 "forever inviolate" framing inherited via 1875 ratification). See *Schools of the Republic v1.3*, Nebraska entry, (see footnote ne-9) through (see footnote ne-11).

[^III-34]: *Jensen v. Dinehart*, 645 P.2d 32, 35 (Utah 1982) (the "free and unfettered" majority opinion authorizing deposit of mineral proceeds in the Uniform School Fund rather than the permanent State School Fund); 1939 amendment to Utah Constitution Article X, § 3, recounted at *id.* at 34–35. See *Schools of the Republic v1.3*, Utah entry, (see footnote ut-22) and (see footnote ut-28) through (see footnote ut-30).
