...
<p class="boxed-insert-title"><strong>The two-man crosscut saw.</strong> <em>— Dave Sullivan, tree-farmer voice. Box 6 of the Sacred Compact 2.0 boxed-insert series; substrate at <code>L4_Deliverables/Sacred_Compact_2_0/boxed_inserts/box_6_two_man_crosscut_saw_2026-05-08.md</code>.</em></p>
...
Section V.5 of this volume walks through the five-layer Knowledge Stack the Library and the duology are built on. It is what the recursion looks like in working detail.
