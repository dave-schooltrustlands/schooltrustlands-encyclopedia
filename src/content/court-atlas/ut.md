...
**Intact-and-funded** (post-reform). Through the 1990s Utah moved from a record of breach and litigation (the *Plateau Mining* and *NPCA* line) to a comprehensive reform: SITLA was established in 1994 as a quasi-independent administrative agency with a single statutory mandate to maximize beneficiary return, separated from competing state policy goals. The SITFO/SITLA framework is now widely cited — including in Margaret Bird's compilation — as the working model for what disciplined fiduciary administration of a school trust looks like in modern practice.
